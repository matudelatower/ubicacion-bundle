...
namespace Matudelatower\UbicacionBundle\Tests\Controller;
...
class DepartamentoControllerTest extends WebTestCase
{
    ...
    public function testCompleteScenario()
    {
        ...
        $form = $crawler->selectButton('Create')->form(array(
            'matudelatower_ubicacionbundle_departamento[field_name]'  => 'Test',
        ...
        $form = $crawler->selectButton('Update')->form(array(
            'matudelatower_ubicacionbundle_departamento[field_name]'  => 'Foo',
            // ... other fields to fill
        ));
